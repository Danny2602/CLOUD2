...
router.get('/generos/:id_genero',generosHandler.deleteGenero);//eliminar genero
//rutas Directores
...
router.get('/directores/:id_director',directoresHandler.deleteDirector);//eliminar genero
//ruta Paises
...
router.get('/paises/:id_pais',paisesHandler.deletePais);//eliminar genero
//ruta Peliculas
...
router.get('/peliculas/:id_pelicula',peliculasHandler.deletePelicula);//eliminar genero
//ruta Carteleras
...
router.get('/carteleras/:id_cartelera',cartelerasHandler.deleteCartelera);//eliminar genero
